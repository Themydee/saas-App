  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        role: {
          farmer: "hsl(var(--role-farmer))",
          transporter: "hsl(var(--role-transporter))",
          warehouse: "hsl(var(--role-warehouse))",
          retailer: "hsl(var(--role-retailer))",
          consumer: "hsl(var(--role-consumer))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
